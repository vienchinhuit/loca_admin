...
export default function Product() {
  const routePage = `${path.ROUTE_ADMIN}${path.ROUTE_PRODUCT}`;
  const queryKey = "products";
  const titlePage = txt.PRODUCT_TITLE;
  ...
  const showEdit = async (idEdit: number | string) => {
    navigate(`${path.ROUTE_ADMIN}${path.ROUTE_PRODUCT_UPDATE}/${idEdit}`);
  };
  ...
  return (
    <div className="py-5">
      ...
      <Function
        ...
        pathCreate={`${path.ROUTE_ADMIN}${path.ROUTE_PRODUCT_CREATE}`}
      />
