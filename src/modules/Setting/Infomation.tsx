      ...
      dataById?.map((data: InformationConfig) => {
        if (data.key === "CONTACT") {
          ...
          form.setFieldsValue({
            ...
            google_map_contact: data.content.google_map_contact,
            google_map_footer: data.content.google_map_footer,
            google_map_branch: data.content.google_map_branch,
          });
        }
      });
    }
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="col-span-1">
            ...
            >
              ...
              <Form.Item
                label={`Map(Footer)`}
                name="google_map_footer"
                className="mt-1"
              >
                <TextArea rows={4} placeholder="Map thông tin chung"/>
              </Form.Item>
              <Form.Item
                label={`Map(Liên hệ)`}
                ...
                className="mt-1"
              >
                <TextArea rows={4} placeholder="Map liên hệ"/>
              </Form.Item>

              <Form.Item
                label={`Map(Hệ thống phân phối)`}
                name="google_map_branch"
                className="mt-1"
              >
                <TextArea rows={4} placeholder="Map hệ thống phân phối"/>
              </Form.Item>
