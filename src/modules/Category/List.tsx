...
export default function Category() {
  const routePage = `${path.ROUTE_ADMIN}${path.ROUTE_CATEGORY}`;
  const queryKey = "categories";
  const titlePage = txt.CATEGORY_TITLE;
  ...
  const showEdit = async (idEdit: number | string) => {
    navigate(`${path.ROUTE_ADMIN}${path.ROUTE_CATEGORY_UPDATE}/${idEdit}`);
  };
  ...
  return (
    <div className="py-5">
      ...
      <Function
        ...
        pathCreate={`${path.ROUTE_ADMIN}${path.ROUTE_CATEGORY_CREATE}`}
      />
